...
const (
	CSVOutputFormat   = OutputType("csv")
	EXLAMOutputFormat = OutputType("xlam")
	XLSMOutputFormat  = OutputType("xlsm")
	XLSXOutputFormat  = OutputType("xlsx")
	XLTMOutputFormat  = OutputType("xltm")
	XLTXOutputFormat  = OutputType("xltx")
)

const (
	excelSheetName   = "output"
	nonExistentSheet = -1
)
